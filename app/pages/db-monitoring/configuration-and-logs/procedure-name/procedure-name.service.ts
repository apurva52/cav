...
export class ProcedureNameService extends Store.AbstractService {
  logger: any;
...
load(payload: DBMonCommonParam): Observable<Store.State> {
  ...
  if (session) {
      ...
      const path = environment.api.dbMonitoring.queryName.endpoint;
      me.controller.post(path, payload).subscribe(
          ...
          (e: any) => {
              ...
              me.logger.error('Procedure Name is not loaded successfully');
          }
      );
      return output;
  }
