...
import { SqlSessionBatchJobsComponent } from './sql-session-batchJob.component';
...
const components = [SqlSessionBatchJobsComponent];
const routes: Routes = [
  {
    path: 'sql-session-batchJob',
    component: SqlSessionBatchJobsComponent,
  },
];
...
export class SqlSessionBatchJobModule { }
