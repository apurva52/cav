...
import { SqlSessionTempDBComponent } from './sql-session-tempDb.component';
...
const components = [SqlSessionTempDBComponent];
const routes: Routes = [
  {
    path: 'sql-session-tempDb',
    component: SqlSessionTempDBComponent,
  },
];
...
export class SqlSessionTempDBModule { }
