...
export class WaitStatisticsService extends Store.AbstractService {
  logger: any;
...
//     }
//       payload.isRealTime = this.dbmonService.isRealTimeAppled;
//       payload.dataSourceName = me.dbmonService.dataSource;
//       payload.dbType = sessionStorage.getItem('dbMonDbmsType');
//       payload.duration = {
//         st: 1617429906000,
//         et: 1617430206000,
//         preset: 'LIVE1'
...
//         payload.globalId = 0;//need to bind
...
//        payload.drilldownWaitCategory = 'NA';
      
//        payload.isRealTimeAppled = this.dbmonService.isRealTimeAppled
