...
@Component({
  selector: 'app-thread-dump-analyse',
  templateUrl: './thread-dump-analyse.component.html',
  styleUrls: ['./thread-dump-analyse.component.css']
})
export class ThreadDumpAnalyseComponent implements OnChanges {
  ...
  constructor(private commonServices: CommonServices, private _cavConfigService: CavConfigService,
    private _navService: CavTopPanelNavigationService, private _ddrData: DdrDataModelService,private ddrRequest:DDRRequestService) {
      this.loading = true;
