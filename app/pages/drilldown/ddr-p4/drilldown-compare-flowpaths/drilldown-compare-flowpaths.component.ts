...
@Component({
  selector: 'app-drilldown-compare-flowpaths',
  templateUrl: './drilldown-compare-flowpaths.component.html',
  styleUrls: ['./drilldown-compare-flowpaths.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class DrillDownCompareFlowpathsComponent implements OnInit {
  selectedFilter =
    ...
    this.commonServices.isToLoadSideBar=false;
     this.cols = [
        ...
        { field: 'appName', header: 'Instance', sortable: 'custom', action: false , width: '75' },
         { field: 'flowpathInstance', header: 'FlowpathInstance', sortable: 'custom', action: true , width: '85'},
        { field: 'urlName', header: 'Business Transaction', sortable: true, action: true , width: '100'},       
        { field: 'urlQueryParamStr', header: 'URL', sortable: true, action: true , width: '220'},
        { field: 'btCatagory', header: 'Category', sortable: true, action: true , width: '70'},
        { field: 'startTime', header: 'Start Time', sortable: 'custom', action: true , width: '90'},
        { field: 'fpDuration', header: 'Response Time(ms)', sortable: 'custom', action: true , width: '85'},
        { field: 'btCpuTime', header: 'CPU Time(ms)', sortable: 'custom', action: true , width: '85'},
        { field: 'methodsCount', header: 'Methods', sortable: 'custom', action: true , width: '65'},
        { field: 'callOutCount', header: 'CallOuts', sortable: 'custom', action: true , width: '65'},
        { field: 'totalError', header: 'CallOut Errors', sortable: 'custom', action: true , width: '75'},
        { field: 'dbCallCounts', header: 'DB Callouts', sortable: 'custom', action: true , width: '70'},
        { field: 'statusCode', header: 'Status', sortable:'custom', action: true , width: '70'},
      ...
      // ];
      this.breadcrumb.add({label: 'Compare Flowpaths', routerLink: '/drilldown-compare-flowpaths'});
