...
@Component({
  selector: 'app-drilldown-db-queries',
  templateUrl: './drilldown-db-queries.component.html',
  styleUrls: ['./drilldown-db-queries.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [EllipsisPipe]
})
export class DrillDownDbQueriesComponent implements OnInit {
  ...
  openQueryCount(nodeInfo:any)
  {
    ...
    if(this._router.url.indexOf('/home/ddrCopyLink') != -1) {
      ...
      this._router.navigate(['/drilldown/drilldown-db-report']);
     }
  }
  getQueryData() {
