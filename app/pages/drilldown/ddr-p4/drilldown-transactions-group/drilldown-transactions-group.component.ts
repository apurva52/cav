...
@Component({
  selector: 'app-drilldown-transactions-group',
  templateUrl: './drilldown-transactions-group.component.html',
  styleUrls: ['./drilldown-transactions-group.component.scss']
})
export class DrillDownTransactionsGroupComponent implements OnInit {
  ...
  isEnabledColumnFilter : boolean= true ;
