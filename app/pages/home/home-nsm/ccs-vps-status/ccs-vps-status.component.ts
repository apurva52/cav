...
import { CcsVps_NAME_DATA } from './ccs-vps.dummy';
import { MenuItem } from 'primeng';
import { NsmhttpservicesService } from './../nsmhttpservices.service'; 
import { dataFortable} from'./ccs-vps.model'
@Component({
  selector: 'app-ccs-vps-status',
  templateUrl: './ccs-vps-status.component.html',
  styleUrls: ['./ccs-vps-status.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class CCsVPsStatusComponent implements OnInit {
