...
import { Project_NAME_DATA } from './nsm-projects.dummy';
...
@Component({
  selector: 'app-nsm-projects',
  templateUrl: './nsm-projects.component.html',
  styleUrls: ['./nsm-projects.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class NsmProjectsComponent implements OnInit { 
  ...
  constructor(private http: NsmhttpservicesService, private router: Router) { }
  ...
  getForTabledata() { 
    this.loading = true;
    this.http.getProjectTeam().subscribe((data) => {
      let response
      response = <any[]>data;
