...
import { Vanders_NAME_DATA } from './nsm-venders.dummy';
...
@Component({
  selector: 'app-nsm-venders',
  templateUrl: './nsm-venders.component.html',
  styleUrls: ['./nsm-venders.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class NsmVendersComponent implements OnInit { 
  ...
  getForTabledata() { 
    this.loading= true;
    this.http.getVenders().subscribe((data) => {
      let response
      response = <any[]>data;
