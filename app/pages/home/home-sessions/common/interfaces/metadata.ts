...
export class Metadata {
  ...
  static getMetaDataObj(dbRecord: any) {
    ...
    if(dbRecord.transactions)
     metadata.transactions = dbRecord.transactions;
  ...
  getEventIconClsFromEventName(name:string){
     let eventdata = this.getEventFromName(name);
     if(eventdata)
      return eventdata.iconCls;
     return null;
  }
