import { HttpAggFilterTable, AutoCompleteData } from  "../../http-filter/service/http-filter.model";


export const HTTP_DETAIL_FILTER_TABLE: HttpAggFilterTable = {
    paginator: {
      first: 0,
      rows: 15,
  ...
  //import { ScatterMapData } from './scatter-map.model';

export const SCATTER_MAP_DATA: any = {
  dropdownOptions: {
    loadOptions: [
    ...
    loadTime: [{ label: '5 mins', value: '5mins' }],
  },
  chartMap: {
    highchart: {
      chart: {
