...
import { PAGE_TABLE } from './service/browser-os.dummy';
import { PageTable } from './service/browser-os.model';
import { Store } from 'src/app/core/store/store';
import { HomePageTabLoadingState,HomePageTabLoadingErrorState,HomePageTabLoadedState } from './service/browser-os-service.state'
import { PageTabService } from './service/browser-os.service';
...
@Component({
  selector: 'app-browser-and-os',
  templateUrl: './browser-and-os.component.html',
  styleUrls: ['./browser-and-os.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class BrowserAndOsComponent implements OnInit {
    ...
    for(let i =0; i < xaxisnamearr.length; i++)
     {
       ...
       let obj= xaxisnamearr[i].detail +"( " + count + " )";
       xaxisname.push(obj)
     }
     return xaxisname;
  }
