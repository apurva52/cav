...
import { PAGE_TABLE } from './service/browser-version.dummy';
import { PageTable } from './service/browser-version.model';
import { Store } from 'src/app/core/store/store';
import { HomePageTabLoadingState,HomePageTabLoadingErrorState,HomePageTabLoadedState } from './service/browser-version-service.state'
import { PageTabService } from './service/browser-version.service';
    ...
    for(let i =0; i < xaxisnamearr.length; i++)
     {
       ...
       let obj= xaxisnamearr[i].browsername +"( " + count + " )";
       xaxisname.push(obj)
     }
     return xaxisname;
  }
