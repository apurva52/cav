...
import { PAGE_TABLE } from './service/browser.dummy';
import { PageTable } from './service/browser.model';
import { Store } from 'src/app/core/store/store';
import { HomePageTabLoadingState,HomePageTabLoadingErrorState,HomePageTabLoadedState } from './service/browser-service.state'
import { PageTabService } from './service/browsertab.service';
    ...
    for(let i =0; i < xaxisnamearr.length; i++)
     {
       ...
       let obj= xaxisnamearr[i].browserall +"( " + count + " )";
       xaxisname.push(obj)
     }
     return xaxisname;
  }
