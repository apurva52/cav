...
import { AutoCompleteModule, MessagesModule , ButtonModule, CardModule, DialogModule, DropdownModule, InputTextModule, MenuModule, MessageModule, MultiSelectModule, TableModule, TooltipModule } from 'primeng';
...
const components = [BrowserComponent];
const routes: Routes = [
  {
    path: 'browser',
