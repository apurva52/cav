...
import { PAGE_TABLE } from './service/connection.dummy';
import { PageTable } from './service/connection.model';
import { Store } from 'src/app/core/store/store';
import { HomePageTabLoadingState,HomePageTabLoadingErrorState,HomePageTabLoadedState } from './service/connection-service.state'
import { PageTabService } from './service/connection.service';
    ...
    for(let i =0; i < xaxisnamearr.length; i++)
     {
       ...
       let obj= xaxisnamearr[i].entityname +"( " + count + " )";
       xaxisname.push(obj)
     }
     return xaxisname;
  }
