...
import { PAGE_TABLE } from './service/device.dummy';
import { PageTable } from './service/device.model';
import { Store } from 'src/app/core/store/store';
import { HomePageTabLoadingState,HomePageTabLoadingErrorState,HomePageTabLoadedState } from './service/device-service.state'
import { PageTabService } from './service/devicetab.service';
    ...
    for(let i =0; i < xaxisnamearr.length; i++)
     {
       ...
       let obj= xaxisnamearr[i].devicetype +"( " + count + " )";
       xaxisname.push(obj)
     }
     return xaxisname;
  }
