...
import { PAGE_TABLE } from './service/location.dummy';
import { PageTable } from './service/location.model';
import { Store } from 'src/app/core/store/store';
import { HomePageTabLoadingState,HomePageTabLoadingErrorState,HomePageTabLoadedState } from './service/location-service.state'
import { PageTabService } from './service/locationtab.service';
    ...
    for(let i =0; i < xaxisnamearr.length; i++)
     {
       ...
       let obj= xaxisnamearr[i].country +"( " + count + " )";
       xaxisname.push(obj)
     }
     return xaxisname;
  }
