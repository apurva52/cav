...
import { PAGE_TABLE } from './service/os-version.dummy';
import { PageTable } from './service/os-version.model';
import { Store } from 'src/app/core/store/store';
import { HomePageTabLoadingState,HomePageTabLoadingErrorState,HomePageTabLoadedState } from './service/os-version-service.state'
import { PageTabService } from './service/os-versiontab.service';
    ...
    for(let i =0; i < xaxisnamearr.length; i++)
     {
       ...
       let obj= xaxisnamearr[i].osname +"( " + count + " )";
       xaxisname.push(obj)
     }
     return xaxisname;
  }
