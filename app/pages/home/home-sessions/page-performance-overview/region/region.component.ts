...
import { PAGE_TABLE } from './service/region.dummy';
import { PageTable } from './service/region.model';
import { Store } from 'src/app/core/store/store';
import { HomePageTabLoadingState,HomePageTabLoadingErrorState,HomePageTabLoadedState } from './service/region-service.state'
import { PageTabService } from './service/regiontab.service';
    ...
    for(let i =0; i < xaxisnamearr.length; i++)
     {
       ...
       let obj= xaxisnamearr[i].region +"( " + count + " )";
       xaxisname.push(obj)
     }
     return xaxisname;
  }
