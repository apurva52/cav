...
import { CavSnmpComponent } from './cav-snmp.component';


const routes: Routes = [
    {
     path: 'configure-snmp-monitor',
      component: CavSnmpComponent
    }
  ];
...
export class ConfigureSNMPModule { }
