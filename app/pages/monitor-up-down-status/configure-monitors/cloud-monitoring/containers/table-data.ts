import { GdfTableData } from "../../add-custom-monitor/cav-snmp-monitor/gdf-table-data";
import { AdvSettings } from "../../add-custom-monitor/containers/adv-settings.data";

import { RemoteConnectionData } from "../../add-custom-monitor/containers/configure-cmd-mon-data";
//import { RemoteConnectionData } from "../../add-custom-monitor/configure-cmd-monitor/service/configure-cmd-mon-data";
