...
export class DdrBreadcrumbService {
  ...
  parentChildInfo: any={};
  constructor( private ddrData: DdrDataModelService, private _router: Router, private commonService: CommonServices, private _activateRoute: ActivatedRoute) {
 ...
 /**
   ...
   if(this.parentComponent == 'flowpath' && this.commonService.splitView )
    ...
    // this._router.events.pipe(filter(e => e instanceof NavigationEnd)).pairwise().first().subscribe((e) => {
