...
export class AdvanceComponent implements OnInit {
  ...
  ngOnInit() {
	...
	this.breadcrumb.add({label: 'Advance', routerLink: `/nd-agent-config/profile/advance/${this.profileId}/${this.index}`});
    });
  ...
  saveCustomKeywordData(keywordData) {
    this.customKeywordData = keywordData
  ...
  saveCustomSettings() {
    this.errDialog = false;
    this.configKeywordsService.keywordData = cloneObject(this.configKeywordsService.keywordData);
    for (let key in this.customKeywordData) {
      this.configKeywordsService.keywordData[key] = this.customKeywordData[key];
    }
    // this.configKeywordsService.saveProfileKeywords(this.profileId);
    this.triggerRunTimeChanges(this.customKeywordData);
  }
