...
export class HttpStatsMonitorsComponent implements OnInit {
  ...
  othersOP: SelectItem[];
  selectedRequestHeader: any;
  selectedResponseHeader: any;
  selectedOthersOp: any;
  selectedNumericOp: any;
  selectedStringOp: any;
  ...
  cols = [
    ...
    { field: 'conditionName', header: 'HTTP Stat Name' },
    { field: 'condition', header: 'Rule' },
    { field: 'fpDumpMode', header: 'Forcefully Dump Flowpath' },
  ...
  ngOnInit() {
    ...
    this.HttpStatsMonitor = cloneObject(this.HttpStatsMonitor);
  ...
  openEditHTTPStatsDialog(): void {
    ...
    this.httpStatsMonitorDetail.htId = this.httpStatsMonitorDetail.htId.toString();
    this.httpStatsMonitorDetail.fpDumpMode = this.httpStatsMonitorDetail.fpDumpMode.toString();
    if (this.httpStatsMonitorDetail.htId == 1)
      this.selectedRequestHeader = this.httpStatsMonitorDetail.hmdId.toString();
    else
      this.selectedResponseHeader = this.httpStatsMonitorDetail.hmdId.toString();
    this.selectedValueType = this.httpStatsMonitorDetail.valId.toString();
    if (this.selectedValueType == 1)
      this.selectedStringOp = this.httpStatsMonitorDetail.optId.toString();
    else if (this.selectedValueType == 2)
      this.selectedNumericOp = this.httpStatsMonitorDetail.optId.toString();
    else
      this.selectedOthersOp = this.httpStatsMonitorDetail.optId.toString();
  }
