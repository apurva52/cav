...
export class MethodMonitorsComponent implements OnInit {
  ...
  cols = [
    ...
    { field: 'methodName', header: 'Fully Qualified Method Name' },
    { field: 'methodDisplayName', header: 'Display Name in Monitor' },
    { field: 'methodDesc', header: 'Description' },
  ]
  ngOnInit() {
    ...
    if (this.configKeywordsService.keywordData != undefined) {
      ...
      this.keywordValue = cloneObject(keyVal['configkeyword']);
    }
    this.methodMonitor = {};
    ...
    this.methodMonitor = cloneObject(this.methodMonitor);
 ...
 ..\ProductUI\gui\src\app\modules\file-explorer\components\config-nd-file-explorer\ */
  ...
  uploadFile(filepath) {
   ...
   /* To select all checkboxes of the table just select by header checkbox*/
  // (onHeaderCheckboxToggle)="onTableHeaderCheckboxToggle($event)"  (write in html p-datatable tag)
