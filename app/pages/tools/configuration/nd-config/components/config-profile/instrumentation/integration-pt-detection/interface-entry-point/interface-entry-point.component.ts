...
export class InterfaceEntryPointComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.interfacePoints = cloneObject(this.interfacePoints);
 ...
 */
  sendHelpNotification() {
    this.configKeywordsService.getHelpContent("Instrumentation", "Integartion Point Detection By Interfaces", "");
  }
