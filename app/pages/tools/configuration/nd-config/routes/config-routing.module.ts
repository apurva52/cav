...
const routes: Routes = [
    {
        path: 'nd-agent-config', component: AppComponentForConfig, children: [
            { path: '', redirectTo: 'homee', pathMatch: 'full' },
            { path: 'homee', component: ConfigHomeComponent },
	    ...
	    { path: 'bci-logs', component: ConfigBCILogsComponent},
            { path: 'instrumentation-profile-maker', component: ConfigImportInstrProfileComponent, canDeactivate: [AuthGuard]  },
	    ...
	    { path: 'memory-profiler', component: ConfigMemoryProflingSessionsComponent },
	    { path: 'mutex-lock', component: ConfigMutexLockSessionsComponent }
        ]
    }
];
