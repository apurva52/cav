export enum ChartType {
    ...
    DUAL_AXIS_STACKED_BAR = 83,
    PERCENTILE_DUAL_AXIS_STACKED_BAR = 89,
    SLAB_COUNT_DUAL_AXIS_STACKED_BAR = 90,

    DUAL_AXIS_STACKED_AREA = 88,
    PERCENTILE_DUAL_AXIS_STACKED_AREA = 91,
    SLAB_COUNT_DUAL_AXIS_STACKED_AREA = 92,
